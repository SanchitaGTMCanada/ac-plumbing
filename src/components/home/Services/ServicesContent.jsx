...
export default function ServicesContent() {
  return (
    <div className="mx-auto mb-20 mt-60 text-center">
      ...
      <span className="inline-flex rounded-full bg-[#123B67]/10 px-6 py-2 text-sm font-semibold uppercase tracking-[0.25em] text-[#123B67]">
        Our Services
      </span>
      ...
      <p className="mx-auto mt-8  text-lg leading-9 text-[#667085]">
