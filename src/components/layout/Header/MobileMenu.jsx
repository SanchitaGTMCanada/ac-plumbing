...
>
  ...
  className="mt-14"
>
  <div className="relative overflow-hidden rounded-3xl border border-[#F4C46A]/60 bg-white/10 p-6 backdrop-blur-2xl shadow-[0_15px_50px_rgba(244,196,106,0.15)]" style={{padding:"10px"}}>
    ...
    <div className="relative z-10">
      ...
      <span className="inline-flex rounded-full border border-[#F4C46A]/40 bg-[#F4C46A]/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-[2px] text-[#F4C46A]" style={{padding:"5px"}}>
        24/7 Emergency Service
      </span>

      <h3 className="mt-4 bg-gradient-to-r from-[#FFF8D5] via-[#F4C46A] to-[#D89C2B] bg-clip-text text-2xl font-bold text-transparent" style={{marginBottom:"5px", color:"#edf6ff75"}}>
        Need Emergency Plumbing?
      </h3>

      <p className="mt-3 text-[15px] leading-7 text-white/80" style={{marginBottom:"5px"}}>
        Available 24/7 for plumbing, heating and emergency repair
